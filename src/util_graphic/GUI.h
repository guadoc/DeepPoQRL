...
const string GRAPHIC_TOOL_FOLDER = "./src/util_graphic/graphism_images/";
const string TABLE_FILE="table/table2.png";
const string POT_FONT ="OpenSans-Semibold.ttf";
const string ACTIVE_SIT_FILE ="table/sit_active.png";
const string SIT_FILE ="table/sit.png";
const string CARD_FOLDER = "cards/";
const string DEALER_BUTTON_FILE ="table/button2.png";
